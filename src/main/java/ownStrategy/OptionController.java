...
public class OptionController {
    ...
    public OptionController(OptionService service, OptionRepository repository, OptionUI ui) {
    ...
    public void start() {
        ...
        // Gra (Gambler mode)
        StrategyCalculator calc = new StrategyCalculator(new ownStrategy.oPattern.PriceWatcher(ticker));
        if (calc.jsonSize() != -1) {
